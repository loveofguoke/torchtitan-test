...
For convergence-curve reassessment of existing distributed artifacts, including
an eight-topology batch report, PASS/FAIL/INCONCLUSIVE handling, smoothed-curve
correlation, and sustained mean-loss checks, see
[DDP_LONG_V2.md](DDP_LONG_V2.md). This V2 profile does not require retraining;
raw pointwise loss errors remain diagnostic only.
