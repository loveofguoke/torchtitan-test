#!/usr/bin/env python3
"""One-step DDP8 BF16 capture with layer 0 wq_a computed in FP32."""
...
CONFIG = FormalExperimentConfig(
    name="glm5-2-gpu-npu-ddp-wq-a-fp32-diagnostic",
    kind="migration",
    ...
    artifact_root="precision_wq_a_fp32_diagnostic_artifacts",
    report_root="precision_wq_a_fp32_diagnostic_reports",
    run_root="precision_wq_a_fp32_diagnostic_runs",
    shared_fixture=True,
...
if __name__ == "__main__":
    os.environ["GLM5_PRECISION_LAYER0_WQ_A_FP32"] = "1"
