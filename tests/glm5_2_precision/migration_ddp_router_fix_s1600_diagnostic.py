#!/usr/bin/env python3
"""1600-step DDP8 Router/Indexer trace for the NPU precision fix."""
...
CONFIG = FormalExperimentConfig(
    name="glm5-2-gpu-npu-ddp-router-fix-s1600-diagnostic",
    kind="migration",
    ...
    training=replace(
        ...
        exploratory_trace_detail=("indexer", "router"),
        extra_args=(
    ...
    artifact_root="precision_router_fix_s1600_diagnostic_artifacts",
    report_root="precision_router_fix_s1600_diagnostic_reports",
    run_root="precision_router_fix_s1600_diagnostic_runs",
    shared_fixture=True,
