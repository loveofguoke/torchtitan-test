...
| median step | 1.424352 s |
| p90 step | 1.430508 s |
| job throughput | 5751.39 tok/s |
...
- Runtime: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-cp4/fsdp2-cp4-r1`
- Artifact: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-cp4/fsdp2-cp4-r1`
- Metrics: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-cp4/fsdp2-cp4-r1/raw_metrics.jsonl`
- Trainer log: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-cp4/fsdp2-cp4-r1/runtime.log`
- Input contract: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-cp4/fsdp2-cp4-r1/attachments/input_contract.json`
