...
| median step | 4.092995 s |
| p90 step | 4.150797 s |
| job throughput | 2001.47 tok/s |
| peak active HBM | 0.042 GiB |
| compile markers | 0 |
| graph breaks | 0 |
| recompiles | 0 |
...
- Runtime: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-eager-performance-no-prof-skip10-nondet-8282f1d8/pp8/pp8-r2`
- Artifact: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-eager-performance-no-prof-skip10-nondet-8282f1d8/pp8/pp8-r2`
- Metrics: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-eager-performance-no-prof-skip10-nondet-8282f1d8/pp8/pp8-r2/raw_metrics.jsonl`
- Trainer log: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-eager-performance-no-prof-skip10-nondet-8282f1d8/pp8/pp8-r2/runtime.log`
- Input contract: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-eager-performance-no-prof-skip10-nondet-8282f1d8/pp8/pp8-r2/attachments/input_contract.json`
