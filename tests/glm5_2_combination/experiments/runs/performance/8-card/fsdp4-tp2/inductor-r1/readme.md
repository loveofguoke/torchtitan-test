...
| median step | 1.083802 s |
| p90 step | 1.093594 s |
| job throughput | 7558.58 tok/s |
| peak active HBM | 0.524 GiB |
| compile markers | 1 |
| graph breaks | 0 |
| recompiles | 1 |
...
- Runtime: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp4-tp2/fsdp4-tp2-r1`
- Artifact: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp4-tp2/fsdp4-tp2-r1`
- Metrics: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp4-tp2/fsdp4-tp2-r1/raw_metrics.jsonl`
- Trainer log: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp4-tp2/fsdp4-tp2-r1/runtime.log`
- Input contract: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp4-tp2/fsdp4-tp2-r1/attachments/input_contract.json`
