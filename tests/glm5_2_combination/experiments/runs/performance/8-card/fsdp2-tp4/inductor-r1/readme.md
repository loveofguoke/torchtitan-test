...
| median step | 2.182384 s |
| p90 step | 2.200028 s |
| job throughput | 3753.69 tok/s |
| peak active HBM | 0.349 GiB |
| compile markers | 1 |
| graph breaks | 0 |
| recompiles | 1 |
...
- Runtime: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-tp4/fsdp2-tp4-r1`
- Artifact: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-tp4/fsdp2-tp4-r1`
- Metrics: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-tp4/fsdp2-tp4-r1/raw_metrics.jsonl`
- Trainer log: `combination_runs/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-tp4/fsdp2-tp4-r1/runtime.log`
- Input contract: `combination_artifacts/self-npu-bf16-random-s30-b64-seq128-seed61-eager-inductor-performance-no-prof-skip10-nondet-9d360eea/fsdp2-tp4/fsdp2-tp4-r1/attachments/input_contract.json`
