...
def _write_summary(
    ...
    lines.extend(
        [
            ...
            "- Performance-only nondeterministic mode was required for NPU Triton",
            "  autotuning; precision acceptance remains a separate deterministic task.",
...
python tests/glm5_2_combination/experiments/tools/summarize_performance.py \\
  --eager-root {eager_root} \\
  --inductor-root {inductor_root} \\
