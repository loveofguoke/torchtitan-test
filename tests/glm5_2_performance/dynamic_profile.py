    ...
    *,
    ...
    return {
        ...
        "experimental_config": {
            ...
            "export_type": list(preset.export_types),
            "msprof_tx": preset.msprof_tx,
            "mstx": preset.mstx,
            "host_sys": list(preset.host_system),
            "mstx_domain_include": list(preset.mstx_domain_include),
            "mstx_domain_exclude": list(preset.mstx_domain_exclude),
