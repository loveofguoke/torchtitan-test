...
`explorations/runs/8-card/<topology>/<run-name>/command_history.jsonl`; every generated
...
```bash
run=tests/glm5_2_performance/explorations/runs/8-card/ddp8/npu-ddp8-bf16-s20-l8-b64-seq128-seed61-distributed-r1-488247ce
...
```bash
base=performance_runs/8-card/ddp8/npu-ddp8-bf16-s20-l8-b64-seq128-seed61-distributed-r1-488247ce
