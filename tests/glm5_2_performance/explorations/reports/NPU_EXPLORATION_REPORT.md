...
- FP32-reduction report:
  `performance_reports/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-distributed-23bade6d.html`
- FP32-reduction cluster DB:
  `performance_runs/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-distributed-23bade6d/cluster/cluster_analysis_output/cluster_analysis.db`
- BF16-reduction report:
  `performance_reports/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-distributed-reduce-bf16-33b5a0e5.html`
- BF16-reduction cluster DB:
  `performance_runs/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-distributed-reduce-bf16-33b5a0e5/cluster/cluster_analysis_output/cluster_analysis.db`
...
are in `MULTI_CARD_TOPOLOGY_REPORT.md` and
`performance_reports/npu-multi-card-topology-comparison.html`.
...
`FAILED_ATTEMPTS.md`. NPU4 must be excluded from formal FSDP data
...
- Profile standard `fsdp8`, `tp8`, `cp8`, and mixed FSDP/TP topologies only
  when all required devices have healthy links. NPU0's current HCCS state
  invalidates an eight-card communication comparison on this node.
