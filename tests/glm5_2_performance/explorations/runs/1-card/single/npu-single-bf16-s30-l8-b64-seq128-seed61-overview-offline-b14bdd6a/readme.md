# npu-single-bf16-s30-l8-b64-seq128-seed61-overview-offline-b14bdd6a
...
| metric | value |
| --- | ---: |
| median step | 1,739.46 ms |
| p90 step | - ms |
| throughput / device | 4,709.52 tok/s |
| throughput / job | 4,709.52 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-overview-offline-b14bdd6a`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-overview-offline-b14bdd6a`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-overview-offline-b14bdd6a/trainer_output/profiling/traces`
