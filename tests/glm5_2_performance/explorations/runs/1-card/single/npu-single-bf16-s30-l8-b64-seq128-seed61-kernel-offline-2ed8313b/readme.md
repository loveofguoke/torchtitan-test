# npu-single-bf16-s30-l8-b64-seq128-seed61-kernel-offline-2ed8313b
...
| metric | value |
| --- | ---: |
| median step | 1,747.83 ms |
| p90 step | - ms |
| throughput / device | 4,686.94 tok/s |
| throughput / job | 4,686.94 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-kernel-offline-2ed8313b`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-kernel-offline-2ed8313b`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/1-card/single/npu-single-bf16-s30-l8-b64-seq128-seed61-kernel-offline-2ed8313b/trainer_output/profiling/traces`
