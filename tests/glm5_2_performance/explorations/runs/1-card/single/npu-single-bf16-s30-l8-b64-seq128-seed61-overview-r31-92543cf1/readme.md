...
6. The workflow generated and executed this training command:
...
7. Parse and analyze the capture with the official tools:
...
8. Produce compact evidence (`manifest.json`, `metrics.jsonl`, `analysis.json`, tool status files) and the HTML report when analysis completed.
