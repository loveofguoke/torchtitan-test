# npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 386.86 ms |
| p90 step | - ms |
| throughput / device | 2,646.98 tok/s |
| throughput / job | 21,175.84 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | reducescatter | 11.00 | 58.33 | 14.77 | 3.95 |
| 0 | allgather | 21.00 | 60.69 | 4.59 | 13.24 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp8/npu-fsdp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-534b554a/graph_visualization`
