# npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 430.39 ms |
| p90 step | - ms |
| throughput / device | 2,379.22 tok/s |
| throughput / job | 19,033.76 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 17.00 | 116.49 | 9.33 | 12.49 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-7e60dbde/graph_visualization`
