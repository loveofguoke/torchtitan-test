# npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 429.69 ms |
| p90 step | - ms |
| throughput / device | 2,383.11 tok/s |
| throughput / job | 19,064.90 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 17.00 | 116.49 | 9.26 | 12.58 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ddp8/npu-ddp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-ff71666e/graph_visualization`
