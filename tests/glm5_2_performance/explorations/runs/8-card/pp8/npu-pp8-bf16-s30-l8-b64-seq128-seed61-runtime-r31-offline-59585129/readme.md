# npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 3,879.40 ms |
| p90 step | - ms |
| throughput / device | 263.96 tok/s |
| throughput / job | 2,111.67 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | receive | 56.00 | 3.67 | 0.22 | 16.37 |
| 0 | send | 56.00 | 0.00 | 0.00 | - |
| 0 | batchsendrecv | 9.60 | 0.52 | 0.03 | 16.12 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-59585129/graph_visualization`
