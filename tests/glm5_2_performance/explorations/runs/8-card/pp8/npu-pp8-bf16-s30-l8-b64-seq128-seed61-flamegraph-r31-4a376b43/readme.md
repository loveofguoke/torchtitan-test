# npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 3,847.53 ms |
| p90 step | - ms |
| throughput / device | 266.14 tok/s |
| throughput / job | 2,129.16 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/pp8/npu-pp8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-4a376b43/graph_visualization`
