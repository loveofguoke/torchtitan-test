# npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 3,239.81 ms |
| p90 step | - ms |
| throughput / device | 316.07 tok/s |
| throughput / job | 2,528.55 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | batchsendrecv | 21.60 | 1.31 | 0.08 | 16.11 |
| 0 | receive | 12.00 | 0.79 | 0.05 | 16.43 |
| 0 | reducescatter | 12.00 | 29.52 | 1.72 | 17.14 |
| 0 | allgather | 12.00 | 15.16 | 0.79 | 19.28 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-pp4/npu-fsdp2-pp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-9278dac8/graph_visualization`
