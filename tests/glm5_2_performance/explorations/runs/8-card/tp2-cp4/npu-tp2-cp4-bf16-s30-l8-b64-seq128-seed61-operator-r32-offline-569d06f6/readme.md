# npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,357.75 ms |
| p90 step | - ms |
| throughput / device | 161.06 tok/s |
| throughput / job | 1,288.51 tok/s |
| peak active hbm | - GiB |
...
| 0 | allgather | 488.00 | 283.09 | 18.95 | 14.94 |
| 0 | reducescatter | 408.00 | 263.94 | 18.70 | 14.11 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-569d06f6/graph_visualization`
