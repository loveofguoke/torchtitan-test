# npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,230.85 ms |
| p90 step | - ms |
| throughput / device | 164.34 tok/s |
| throughput / job | 1,314.75 tok/s |
| peak active hbm | - GiB |
...
| 0 | allgather | 488.00 | 283.09 | 18.62 | 15.21 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp2-cp4/npu-tp2-cp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-e166ffb3/graph_visualization`
