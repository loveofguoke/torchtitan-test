# npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 734.44 ms |
| p90 step | - ms |
| throughput / device | 1,394.26 tok/s |
| throughput / job | 11,154.05 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | alltoallv | 35.00 | 28.59 | 2.14 | 13.34 |
| 0 | allreduce | 8.00 | 0.00 | 0.01 | 0.01 |
| 0 | reducescatter | 11.00 | 19.80 | 5.20 | 3.81 |
| 0 | allgather | 21.00 | 22.15 | 1.41 | 15.74 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-7a56058a/graph_visualization`
