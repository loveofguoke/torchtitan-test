# npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 697.90 ms |
| p90 step | - ms |
| throughput / device | 1,467.26 tok/s |
| throughput / job | 11,738.10 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | alltoallv | 35.00 | 28.45 | 2.14 | 13.27 |
| 0 | allreduce | 8.00 | 0.00 | 0.01 | 0.01 |
| 0 | reducescatter | 11.00 | 19.80 | 5.35 | 3.70 |
| 0 | allgather | 21.00 | 22.15 | 1.43 | 15.51 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-43246350/graph_visualization`
