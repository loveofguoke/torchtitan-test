# npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 746.17 ms |
| p90 step | - ms |
| throughput / device | 1,372.33 tok/s |
| throughput / job | 10,978.67 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/ep8/npu-ep8-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-9e4d77ce/graph_visualization`
