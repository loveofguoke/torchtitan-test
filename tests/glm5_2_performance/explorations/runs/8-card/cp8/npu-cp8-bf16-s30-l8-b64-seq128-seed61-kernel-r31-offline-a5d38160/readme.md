# npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 2,897.27 ms |
| p90 step | - ms |
| throughput / device | 353.44 tok/s |
| throughput / job | 2,827.49 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | reducescatter | 216.00 | 584.10 | 136.10 | 4.29 |
| 0 | allgather | 368.00 | 610.34 | 42.16 | 14.48 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/cp8/npu-cp8-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-a5d38160/graph_visualization`
