# npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 13,781.13 ms |
| p90 step | - ms |
| throughput / device | 74.30 tok/s |
| throughput / job | 594.44 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | batchsendrecv | 29.60 | 0.92 | 0.07 | 13.12 |
| 0 | receive | 4.00 | 0.13 | 0.01 | 13.45 |
| 0 | allgather | 308.00 | 26.40 | 1.60 | 16.46 |
| 0 | allreduce | 617.00 | 0.00 | 0.00 | 0.01 |
| 0 | reducescatter | 404.00 | 40.18 | 2.72 | 14.75 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/fsdp2-tp2-pp2/npu-fsdp2-tp2-pp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-e2d27edb/graph_visualization`
