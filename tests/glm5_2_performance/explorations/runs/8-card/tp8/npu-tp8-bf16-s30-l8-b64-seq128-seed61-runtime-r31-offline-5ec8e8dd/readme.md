# npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,418.67 ms |
| p90 step | - ms |
| throughput / device | 159.53 tok/s |
| throughput / job | 1,276.28 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 865.00 | 146.80 | 10.55 | 13.92 |
| 0 | reducescatter | 192.00 | 55.05 | 4.07 | 13.52 |
| 0 | allgather | 120.00 | 55.05 | 3.38 | 16.28 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-5ec8e8dd/graph_visualization`
