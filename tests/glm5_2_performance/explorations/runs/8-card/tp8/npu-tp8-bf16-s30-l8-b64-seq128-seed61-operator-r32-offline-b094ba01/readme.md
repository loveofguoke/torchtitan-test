# npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,209.44 ms |
| p90 step | - ms |
| throughput / device | 164.91 tok/s |
| throughput / job | 1,319.28 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 865.00 | 146.80 | 10.54 | 13.92 |
| 0 | reducescatter | 192.00 | 55.05 | 4.07 | 13.51 |
| 0 | allgather | 120.00 | 55.05 | 3.38 | 16.29 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b094ba01/graph_visualization`
