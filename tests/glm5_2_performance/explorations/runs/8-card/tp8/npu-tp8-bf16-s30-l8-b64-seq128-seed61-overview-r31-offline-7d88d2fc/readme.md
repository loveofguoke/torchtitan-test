# npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc
...
5. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,274.99 ms |
| p90 step | - ms |
| throughput / device | 163.19 tok/s |
| throughput / job | 1,305.50 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/8-card/tp8/npu-tp8-bf16-s30-l8-b64-seq128-seed61-overview-r31-offline-7d88d2fc/graph_visualization`
