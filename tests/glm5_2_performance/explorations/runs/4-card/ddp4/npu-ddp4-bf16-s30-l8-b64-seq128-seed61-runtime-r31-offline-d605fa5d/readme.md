# npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 738.94 ms |
| p90 step | - ms |
| throughput / device | 2,771.53 tok/s |
| throughput / job | 11,086.11 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 28.00 | 199.81 | 12.63 | 15.82 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ddp4/npu-ddp4-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-d605fa5d/graph_visualization`
