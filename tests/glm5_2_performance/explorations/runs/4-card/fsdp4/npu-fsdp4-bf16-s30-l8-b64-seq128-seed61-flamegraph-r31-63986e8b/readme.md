# npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 714.03 ms |
| p90 step | - ms |
| throughput / device | 2,868.22 tok/s |
| throughput / job | 11,472.87 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/fsdp4/npu-fsdp4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-63986e8b/graph_visualization`
