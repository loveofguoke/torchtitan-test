# npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 2,697.56 ms |
| p90 step | - ms |
| throughput / device | 759.20 tok/s |
| throughput / job | 3,036.82 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/cp4/npu-cp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-ee5fecfe/graph_visualization`
