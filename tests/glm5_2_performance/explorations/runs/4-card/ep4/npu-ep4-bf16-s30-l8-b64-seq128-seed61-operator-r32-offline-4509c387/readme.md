# npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,019.78 ms |
| p90 step | - ms |
| throughput / device | 2,008.27 tok/s |
| throughput / job | 8,033.08 tok/s |
| peak active hbm | - GiB |
...
| 0 | allgather | 42.00 | 37.93 | 2.39 | 15.86 |
| 0 | reducescatter | 22.00 | 33.94 | 2.51 | 13.50 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-4509c387/graph_visualization`
