# npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,016.35 ms |
| p90 step | - ms |
| throughput / device | 2,015.06 tok/s |
| throughput / job | 8,060.23 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/ep4/npu-ep4-bf16-s30-l8-b64-seq128-seed61-flamegraph-r31-d83da0d2/graph_visualization`
