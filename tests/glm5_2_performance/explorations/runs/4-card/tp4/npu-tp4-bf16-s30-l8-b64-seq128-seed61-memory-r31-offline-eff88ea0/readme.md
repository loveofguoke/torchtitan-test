# npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,543.66 ms |
| p90 step | - ms |
| throughput / device | 312.97 tok/s |
| throughput / job | 1,251.90 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-eff88ea0/graph_visualization`
