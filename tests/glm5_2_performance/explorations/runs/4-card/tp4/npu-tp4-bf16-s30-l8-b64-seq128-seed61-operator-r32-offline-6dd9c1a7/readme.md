# npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,030.11 ms |
| p90 step | - ms |
| throughput / device | 339.63 tok/s |
| throughput / job | 1,358.51 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 865.00 | 125.83 | 7.97 | 15.79 |
| 0 | reducescatter | 192.00 | 47.19 | 3.13 | 15.06 |
| 0 | allgather | 120.00 | 47.19 | 2.83 | 16.65 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/tp4/npu-tp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-6dd9c1a7/graph_visualization`
