# npu-pp4-bf16-s20-l8-b64-seq128-seed61-distributed-profiler-off-r1-d56db519
...
| metric | value |
| --- | ---: |
| median step | 3,175.36 ms |
| p90 step | 3,243.78 ms |
| throughput / device | 644.97 tok/s |
| throughput / job | 2,579.88 tok/s |
| peak active hbm | 0.066 GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s20-l8-b64-seq128-seed61-distributed-profiler-off-r1-d56db519`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/pp4/npu-pp4-bf16-s20-l8-b64-seq128-seed61-distributed-profiler-off-r1-d56db519`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s20-l8-b64-seq128-seed61-distributed-profiler-off-r1-d56db519/trainer_output/profiling/traces`
