# npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 6,330.68 ms |
| p90 step | - ms |
| throughput / device | 323.50 tok/s |
| throughput / job | 1,294.02 tok/s |
| peak active hbm | - GiB |
...
| 0 | batchsendrecv | 41.60 | 2.62 | 0.16 | 16.06 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/4-card/pp4/npu-pp4-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-b6e30419/graph_visualization`
