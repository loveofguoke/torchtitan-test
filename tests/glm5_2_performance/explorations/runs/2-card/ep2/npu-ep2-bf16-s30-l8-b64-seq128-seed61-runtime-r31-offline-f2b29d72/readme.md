# npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,814.60 ms |
| p90 step | - ms |
| throughput / device | 2,257.25 tok/s |
| throughput / job | 4,514.50 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | alltoallv | 140.00 | 58.90 | 3.03 | 19.47 |
| 0 | allgather | 84.00 | 50.57 | 2.65 | 19.06 |
| 0 | reducescatter | 44.00 | 45.25 | 2.65 | 17.07 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-runtime-r31-offline-f2b29d72/graph_visualization`
