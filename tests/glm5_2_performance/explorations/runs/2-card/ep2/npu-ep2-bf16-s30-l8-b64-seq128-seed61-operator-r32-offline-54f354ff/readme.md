# npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,830.58 ms |
| p90 step | - ms |
| throughput / device | 2,237.54 tok/s |
| throughput / job | 4,475.07 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ep2/npu-ep2-bf16-s30-l8-b64-seq128-seed61-operator-r32-offline-54f354ff/graph_visualization`
