# npu-ddp2-bf16-s30-l8-b64-seq128-seed61-overview-offline-240cc2ba
...
| metric | value |
| --- | ---: |
| median step | 720.41 ms |
| p90 step | - ms |
| throughput / device | 5,685.67 tok/s |
| throughput / job | 11,371.35 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-overview-offline-240cc2ba`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-overview-offline-240cc2ba`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-overview-offline-240cc2ba/trainer_output/profiling/traces`
