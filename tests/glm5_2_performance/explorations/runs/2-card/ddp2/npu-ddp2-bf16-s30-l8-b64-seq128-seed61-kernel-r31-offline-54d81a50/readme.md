# npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,450.71 ms |
| p90 step | - ms |
| throughput / device | 2,823.45 tok/s |
| throughput / job | 5,646.91 tok/s |
| peak active hbm | - GiB |
...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | allreduce | 50.00 | 265.93 | 13.79 | 19.28 |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/ddp2/npu-ddp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-54d81a50/graph_visualization`
