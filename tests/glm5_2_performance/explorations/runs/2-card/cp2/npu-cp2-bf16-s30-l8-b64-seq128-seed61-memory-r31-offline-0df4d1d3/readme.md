# npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3
...
4. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 2,724.11 ms |
| p90 step | - ms |
| throughput / device | 1,503.61 tok/s |
| throughput / job | 3,007.22 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/cp2/npu-cp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-0df4d1d3/graph_visualization`
