# npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc
...
| metric | value |
| --- | ---: |
| median step | 1,394.92 ms |
| p90 step | - ms |
| throughput / device | 2,936.36 tok/s |
| throughput / job | 5,872.72 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-memory-r31-offline-7e7ffacc/graph_visualization`
