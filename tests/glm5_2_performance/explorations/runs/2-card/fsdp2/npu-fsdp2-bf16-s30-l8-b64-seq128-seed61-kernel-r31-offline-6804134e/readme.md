# npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e
...
3. Parse and analyze the capture with the official tools:
   ...
   - `advisor` (return code `0`)
     ...
     ```bash
     /workspace/y50064852_yyb/.codex-tools/msprof-analyze-cli advisor all -d /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/trainer_output/profiling/traces -o /workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/advisor
     ```
...
| metric | value |
| --- | ---: |
| median step | 1,401.92 ms |
| p90 step | - ms |
| throughput / device | 2,921.71 tok/s |
| throughput / job | 5,843.43 tok/s |
| peak active hbm | - GiB |
...
- raw run: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e`
- compact artifact: `/workspace/y50064852_yyb/torchtitan-test/performance_artifacts/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e`
...
- MindStudio input: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/trainer_output/profiling/traces`
- TensorBoard logdir: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/trainer_output/tensorboard`
- flame graph stacks/SVG root: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/trainer_output/profiling/traces`
- torch.compile visualization: `/workspace/y50064852_yyb/torchtitan-test/performance_runs/2-card/fsdp2/npu-fsdp2-bf16-s30-l8-b64-seq128-seed61-kernel-r31-offline-6804134e/graph_visualization`
