...
"""Composable single-device GLM-5 parity harness.
...
* ``Glm5ParitySuite`` selects implementation x precision endpoints at runtime.
...
class Glm5ParitySuite(
    ...
    def _load_fixture(
        ...
        with ParityArtifactReader(cls.FIXTURE_PATH) as reader:
            ...
            if reader.manifest.get("suite") != GLM5_PARITY_FIXTURE_SUITE:
                raise ParityArtifactError(
