...
Shared graph environment variables:
  ...
  GRAPH_VETTED_POINTWISE_AUTOTUNE
                              Allow deterministic pointwise autotuning; default: 1
...
graph_env_init() {
    ...
    VETTED_POINTWISE_AUTOTUNE=${GRAPH_VETTED_POINTWISE_AUTOTUNE:-1}
    ...
    graph_env_require_boolean GRAPH_VETTED_POINTWISE_AUTOTUNE \
        "$VETTED_POINTWISE_AUTOTUNE"
    ...
    if [[ ${TORCHTITAN_GRAPH_ENV_READY:-} != "$GRAPH_BACKEND" ]]; then
        ...
        exec env -i \
            ...
            TORCHTITAN_VETTED_POINTWISE_AUTOTUNE="$VETTED_POINTWISE_AUTOTUNE" \
            ...
            GRAPH_VETTED_POINTWISE_AUTOTUNE="$VETTED_POINTWISE_AUTOTUNE" \
    ...
    export TORCHTITAN_VETTED_POINTWISE_AUTOTUNE="$VETTED_POINTWISE_AUTOTUNE"
...
- Deterministic pointwise autotune is vetted: \`$VETTED_POINTWISE_AUTOTUNE\`
